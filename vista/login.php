...
<div class="row justify-content-center bg-secondary p-3">
    ...
    <form action="" method="post" class="form col-4 bg-dark p-3 rounded" onsubmit="login(event);">
        <h2 class="text-warning my-5">Ingresa tus credenciales</h2>
        <div class="input-group my-5">
            <span class="input-group-text" id="basic-addon1"><i class="fas fa-at"></i></span>
            <input id="txtEmail" required class="form-control" type="email" placeholder="Ingrese su email" name="email" aria-label="email" aria-describedby="basic-addon1">
        </div>
        <div class="input-group my-5">
            <span class="input-group-text" id="basic-addon1"><i class="fas fa-key"></i></span>
            <input id="txtClave" required class="form-control" type="password" placeholder="Ingrese su contraseña" name="clave" aria-label="clave" aria-describedby="basic-addon1">
        </div>
